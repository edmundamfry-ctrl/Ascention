...
THE SETTING: Serenity Ridge, a fenced ranch compound in rural Montana. Locations: the dormitory bunkhouses, the Chapel of Light (a converted barn), the mess hall, Father Solaris's private quarters (the only building with A/C), the House of Light (an old house used by Father Solaris for his sexual rituals), the motor pool (where his Trans Am and the players' confiscated keys are), the "Sacred Reservoir" (an above-ground pool), the perimeter fence, and the woods beyond. Nearest town: Grange, 30 miles away. It is 1985 — no cell phones, no internet. A payphone in town is the only way to call out.
