  ...
  return (
    <div style={{ padding: 24, maxWidth: 620, margin: '0 auto', width: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', minHeight: '100vh', justifyContent: 'center' }}>
      ...
      <div style={{ ...S.card, borderColor: CYAN, lineHeight: 1.65, fontSize: '0.92rem', color: '#d8c8e8' }}>
        ...
        <p>
          You signed some papers. You don't fully remember which ones. Now you're living on a fenced compound called <b style={{ color: CYAN }}>Serenity Ridge</b>, they've got your car keys, and you've just noticed the dormitory doors don't open from the inside.
        </p>
        <p>
          You don't believe the world is ending. But you're stuck here, the clock is ticking, and Solaris's head of security — a mustached ex-mall-cop who takes his job <i>very</i> seriously — is starting to watch you.
        </p>
        <p style={{ marginBottom: 0, color: GREEN }}>
          <b>You have 40 days.</b> Escape the compound. Or gather proof and bring the whole thing down. Or climb the ranks, out-hustle Solaris, and take it over yourself. How you survive is up to you.
        </p>
      </div>

      <div style={{ ...S.card, borderColor: PURPLE, marginTop: 12, fontSize: '0.78rem', color: DIM, lineHeight: 1.6 }}>
        <div style={S.label(PURPLE)}>HOW TO PLAY</div>
        Type whatever you want to do — it's a conversation with a game master. When you try something risky, dice appear: roll them, then see what happens. Keep an eye on your <b style={{ color: AMBER }}>Heat</b> (how suspicious security is) up top. Getting caught means re-education. A gunfight can get you killed. Play it smart, or don't.
      </div>
...
export default function Ascension() {
  ...
  const callGM = useCallback(async (playerMessage, isOpener = false) => {
    ...
    try {
      ...
      const roll = detectPendingRoll(gmText)
